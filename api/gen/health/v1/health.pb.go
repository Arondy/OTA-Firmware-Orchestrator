...
const file_health_v1_health_proto_rawDesc = "" +
	...
	"\rHealthService\x12L\n" +
	"\vCheckHealth\x12\x1d.health.v1.CheckHealthRequest\x1a\x1e.health.v1.CheckHealthResponseBHZFgithub.com/Arondy/OTA-Firmware-Orchestrator/api/gen/health/v1;healthv1b\x06proto3"
...
var file_health_v1_health_proto_goTypes = []any{
	(*CheckHealthRequest)(nil),  // 0: health.v1.CheckHealthRequest
	(*CheckHealthResponse)(nil), // 1: health.v1.CheckHealthResponse
}
var file_health_v1_health_proto_depIdxs = []int32{
	0, // 0: health.v1.HealthService.CheckHealth:input_type -> health.v1.CheckHealthRequest
	1, // 1: health.v1.HealthService.CheckHealth:output_type -> health.v1.CheckHealthResponse
